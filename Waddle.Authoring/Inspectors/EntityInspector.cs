...
namespace Waddle.Authoring.Inspectors
{
    ...
    public class EntityInspector : Editor
    {
        ...
        private static readonly Vector2 WindowSize = new(200, 400);
        ...
        {
            _modulesProperty = serializedObject.FindProperty("_entity.Modules");
        ...
        private void BindItem(VisualElement element, int moduleIndex)
        {
            ...
            fieldList.text = ObjectNames.NicifyVariableName(moduleProperty.FindPropertyRelative("Name").stringValue);
        ...
        private VisualElement CreateFieldInspector(SerializedProperty fieldProperty)
        {
            ...
            var field = new SerializedObject(fieldProperty.FindPropertyRelative("Value").objectReferenceValue);
            InspectorElement.FillDefaultInspector(fieldRoot, field, this);
            fieldRoot.RemoveAt(0);
            if(fieldRoot.childCount == 1)
            {
                fieldRoot[0].Q<PropertyField>().label = fieldProperty.FindPropertyRelative("Name").stringValue;
            }
        ...
        private void AddModuleFromGuid(string guid)
        {
            ...
            var module = moduleDefinitionContainer.ToModule();
